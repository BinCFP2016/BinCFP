 ...
 * TraceID =(addr & 0x00ffffff)<<8|BBNumber; ScratchReg is used to transfer TraceID between two analysis function.
...
UINT32 PIN_FAST_ANALYSIS_CALL setCJMP (ADDRINT addr, UINT32 taken) //inlined
{

  BBNumber+=(taken xor 1);
  return (addr & 0x00ffffff)<<8|BBNumber;
 // return taken;
...
VOID Trace(TRACE trace, VOID *v)
{
    ...
    TRACE_InsertCall(trace, IPOINT_BEFORE, AFUNPTR(traceAddr), IARG_END);
